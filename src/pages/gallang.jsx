      ...
      <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
          <div className='relative z-10' style={{ height: '100%', width: '100%' }}>
            <Image className='absolute' fill style={{ objectFit: 'contain'}} src="projects/gallang.png" alt='Search Engine Image' />
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 grid-rows-4 gap-8 pt-8 '>
          ...
          <div className='col-span-4 md:col-span-1 row-span-1.5 min-h-0 shadow-xl shadow-gray-400 rounded-xl p-4 '>
            <div className='p-2 '>
