      ...
      <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
          <div className='relative z-10' style={{ height: '100%', width: '100%' }}>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-30 p-2'>
              <h2 className='pb-3'>Search Engine/Elastic Search</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
          <div className='col-span-4'>
            ...
            <a href='https://lexieqiqi.github.io/Yuqi/DD2476_Personalized_search_project.pdf' target='__blank__'>
            <button className='px-8 py-2 mt-4 mr-8'>Paper</button>
            </a>
            <a href='https://github.com/Lexieqiqi/DD2476PersonalizedSearch' target='__blank__'>
